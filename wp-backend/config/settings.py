...
INSTALLED_APPS = [
    ...
    # Local apps (copied from yogi-backend)
    'users',
    'whatsapp',
    'whatsapp_dashboard',
]
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://localhost:5173",
    "http://localhost:8080",  # Vite dev server (yogi-sarbat-admin-hub)
]
...
# Channels (Redis required for websockets)
CHANNEL_LAYERS = {
    "default": {
...
# WhatsApp Cloud API settings (fill in wp/.env)
...
WHATSAPP_BUSINESS_ACCOUNT_ID = env('WHATSAPP_BUSINESS_ACCOUNT_ID', default=None)
WHATSAPP_VERIFY_TOKEN = env('WHATSAPP_VERIFY_TOKEN', default=None)
