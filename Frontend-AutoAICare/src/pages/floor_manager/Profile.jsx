            ...
            <div className="border-b border-gray-200 overflow-x-auto">
                <div className="flex gap-4 min-w-max">
                    <button
                        ...
                        className={`whitespace-nowrap px-4 py-3 text-sm md:text-base font-medium border-b-2 transition-colors ${activeTab === 'personal'
                    ...
                    <button
                        ...
                        className={`whitespace-nowrap px-4 py-3 text-sm md:text-base font-medium border-b-2 transition-colors ${activeTab === 'security'
                            ? 'border-primary text-primary'
                            : 'border-transparent text-gray-600 hover:text-gray-900'
                            }`}
                    >
                        ...
                        <form onSubmit={handleProfileSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    {/* <p className="text-xs text-gray-500 mt-1">Enter 10 code</p> */}
                                </div>
                            </div>
