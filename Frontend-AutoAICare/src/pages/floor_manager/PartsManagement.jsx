        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex gap-2">
                    <Link to="/floor-manager/parts/analytics">
                        <Button variant="outline" className="text-sm">
                            <BarChart3 className="mr-1 md:mr-2 h-3 w-3 md:h-4 md:w-4" />
                            <span className="hidden sm:inline">Analytics</span>
                        </Button>
                    </Link>
                    <Button onClick={() => { resetForm(); setShowAddModal(true); }} className="text-sm">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                    <Card className="p-3 md:p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-xs md:text-sm text-gray-600">Total Parts</p>
                                <p className="text-xl md:text-2xl font-bold">{stockSummary.total_parts}</p>
                            </div>
                    ...
                    <Card className="p-3 md:p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xl md:text-2xl font-bold text-red-600">{stockSummary.out_of_stock}</p>
                            </div>
                    ...
                    <Card className="p-3 md:p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xl md:text-2xl font-bold text-orange-600">{stockSummary.low_stock}</p>
                            </div>
                    ...
                    <Card className="p-3 md:p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-xs md:text-sm text-gray-600">Stock Value</p>
                                <p className="text-xl md:text-2xl font-bold text-green-600">₹{parseFloat(stockSummary.total_stock_value || 0).toFixed(2)}</p>
                            </div>
